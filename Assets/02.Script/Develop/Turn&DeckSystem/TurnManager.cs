...
public class TurnManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        //battleManager.SetEnemy(enemyUnit);
    ...
    private void StartPlayerTurn()
    {
        ...
        {
            Debug.Log($"체력이 0인 Unit 있음 : PL - {playerUnit.currentHP} / EM - {enemyUnit.currentHP}");
            return;
        }
    ...
    public void EndTurn()
    {
        Debug.Log($"[EndTurn 호출됨] 현재 턴: {currentTurn}");
